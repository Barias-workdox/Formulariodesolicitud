const e = {
  ...
  filtersGroup: {
    ...
    maxActiveFiltersReached: "You have reached the maximum number of filters allowed. Remove one to add another."
  },
  locales: {
    en: "English",
    es: "Spanish",
  ...
  collaborationDetails: {
    ...
    deletedDocumentAlert: {
      title: "This document has been deleted from the Workflow and is no longer possible to register it in the collaboration."
    }
  },
  contractNegotiationCollaboration: {
    ...
    bannerCollaboration: {
      canceled: "The negotiation was canceled in {{date}} You can review the reason for cancellation in the history.",
    ...
    approvalInformation: "The approval will be recorded in the activity history and in the list of approvers for the contract negotiation.",
    ...
    finalize: "Finalize",
    finalizeWarning: "You are finalizing contract negotiations with one or more documents containing pending approvals.",
    finalizeInfo: "Select the documents you want to be added to the Workflow at the end of the negotiation.",
    cancel: "Cancel collaboration",
    cancelModal: {
      alert: "By confirming the cancellation, the negotiation process with third parties will stop. This action will be recorded in the audit, and in the Workflow history.",
    ...
    loadNewVersionInfo: "When uploading a new version, the approval record of all users will be automatically deleted.",
    load: "Load",
    collaborationActivities: {
      create: "<strong>{{userFullName}}</strong> initiated a new contract negotiation collaboration.",
      ...
      documentApproved: '<strong>{{userFullName}}</strong> approved version {{version}} of the document "{{documentName}}".',
      viewedDocument: '<strong>{{userFullName}}</strong> viewed the document "{{documentName}}".',
      downloadDocument: '<strong>{{userFullName}}</strong> downloaded the document "{{documentName}}".',
      collaborationComment: "<strong>{{userFullName}}</strong> made a comment:",
      documentUpload: '<strong>{{userFullName}}</strong> uploaded a new version of the document "{{documentName}}" (Version {{version}}).',
      approvalsRestart: 'Approvals have been restarted because a new version was uploaded to the document "{{documentName}}".',
      versionUpload: '<strong>{{userFullName}}</strong> uploaded a new version of the document "{{documentName}}" (Version {{version}}).',
      newDocuments: "<strong>{{userFullName}}</strong> added new documents to the contract negotiation:",
      deletedDocuments: "<strong>{{userFullName}}</strong> deleted a document from the contract negotiation:",
      newThirdParties: "<strong>{{userFullName}}</strong> added new users to contract negotiation:",
      deletedThirdParties: "<strong>{{userFullName}}</strong> removed a user from contract negotiation:",
      documentUpdatedLocally: '<strong>{{userFullName}}</strong> has edited a document generating a new version of the document "{{documentName}}" (Version {{version}}).'
    }
  },
  collaborationUploadDetails: {
    ...
    notification: "The uploaded documents will appear as antecedent in the workflow after the collaboration is completed.",
  ...
  webdoxAI: {
    ...
    suggestionsSection: {
      description: "To search faster, use <bold>'Suggestions'</bold>. They are specific commands that help you get precise results.",
    ...
    assistantDisclaimer: "As an AI assistant, I can make mistakes. Always verify important information.",
    legalWhisperDefaultMessage: {
      title: "Do you have any questions about legal matters?",
      content: "Ask your question, and I will provide guidance on topics like labor law, tax law, administrative law, and more. 👩🏻‍💻",
      disclaimer: "Remember: this consultation is exclusively about legal matters, not about visible documentation."
    },
    planUsage: {
      popovers: {
        planTrial: {
          ...
          description: "Your trial allows you to make up to {{total}} general chat consultations per company account.",
    ...
    webdoxAIButton: {
      ...
      documentInProcessInformation: {
        detail: "I am <bold>Brain Companion</bold>, your virtual assistant. I'm here to help you with anything you need. Please give me a few minutes while I process the document information..."
      },
      genericErrorInformation: {
        title: "Document not processed",
        detail: "Unfortunately, I couldn't process the document. I suggest you <bold>reload the page</bold> to try again...",
        actions: {
      ...
      chatShortcutInformation: {
        detail: "I am <bold>Brain Companion</bold>, your virtual assistant.<br/>How can I assist you?"
      },
      legalWhisperGreetings: {
        detail: "I am <bold>Legal Whisper</bold>, your legal consultant. I can assist you with any legal inquiries you have to support your processes and legal negotiations."
      },
      suiteAIGreetings: {
        detail: "Alongside our AI assistants, you can quickly query documents with <bold>Brain Companion</bold> or solve your legal doubts with <bold>Legal Whisper</bold>. Your smart ally for every need! 👩🏻‍💻"
      },
      ...
      businessSummaryGreetings: {
        detail: "Hello, I invite you to review the <bold>document summary</bold> generated with AI ✨."
      },
      encryptedDocumentError: {
        title: "Invalid Document",
        detail: "<strong>The document is encrypted</strong> and cannot be processed. We recommend deleting it, decrypting it, and uploading it again."
      }
    },
    dataExtraction: {
      ...
      dataExtractionDisclaimer: "<strong>Brain Data Extraction</strong> is an AI-powered module that allows extracting relevant data from contracts.",
      description: "Here you will find a summary of the data extracted from the document. If there is an error, use the editing option. ✍",
      contractTypeModification: "If you modify the contract type, Brain Companion will provide new suggestions for the document.",
      contractData: "CONTRACT DATA",
      contractType: "Contract Type",
      contractSummaryGeneration: {
        title: "Generate a summary",
        description: "A brief version of the document that highlights the main ideas of the original content.",
        isLoading: "Generating summary..."
      },
      contractReportGeneration: {
        title: "Generate a report",
        description: "A tool that presents and organizes the key details of the contract in a clear manner.",
      ...
      metadataAreLoadingMsg: "We are extracting some attributes using AI. Once the process is completed, they will automatically appear in their corresponding fields.",
    ...
    legalWhisperSettings: {
      ...
      deleteConversationModal: {
        ...
        description: 'Are you sure you want to delete the conversation ["<strong>{{conversationTitle}}</strong>"]? This action is irreversible and cannot be undone.',
        submit: "Yes, delete"
      },
    ...
    legalWhisperAnswerRating: {
      ...
      mainAnswerProblem: {
        title: "What observations do you have about the answer (the text provided by Legal Whisper)?",
        options: {
          notAlignedWithInvestigation: "The answer is not consistent with the judicial investigation.",
    ...
    chat: {
      ...
      emptyLoadingMessagesText: "We are preparing the document for your queries with the assistant...",
      emptyPreviousMessagesText: "I am loading the previously queried information, please give me a moment...",
      emptyMessagesText: "You can now start conversations with Webdox AI",
      suggestionsTextV1: "Use the assistant's suggestions to enhance your experience with the document.",
      suggestionsText: "Use the contract type suggestions to enhance your experience with the assistant.",
      ...
      errors: {
        ...
        fetchConversation: "An error occurred while loading the conversation history. Please try again."
      },
      firstAnswer: {
      ...
      contractKindAnswer: {
        ...
        description2: "If the contract type information is incorrect, you can modify it at any time.",
      ...
      blockedFeatureInfo: "The owner of this account has blocked this functionality, please contact an administrator for more information.",
      customPrompts: {
        ...
        deleteModal: {
          ...
          description: "Once you delete the prompt, it will disappear from the initial chat list with Brain.",
          submit: "Yes, delete"
        },
        formModal: {
  ...
  storybook: {
    deprecatedComponent: "Deprecated component, prefer <strong>{{name}}</strong> for new initiatives"
  },
  deleteModal: {
    modal: {
      confirm: {
...
Do you want to continue anyway?`
    ...
    distributionModeOptions: {
      ...
      freeLabel: "(Free)",
      defaultDescription: "Requests are NOT automatically assigned. Any group member can see them and choose to take them manually.",
      globalSequential: "Automatic assignment by global workload",
      globalSequentialDescription: "Consider requests of any type received by a user during the calendar month."
    }
  },
  suggestionsInput: {
