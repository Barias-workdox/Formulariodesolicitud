...
import { MessageBoxPluginNames, MessageBoxRichTextOptions } from './message-box.constants';
...
export type CompactMessageBoxProps = Omit<MessageBoxProps, 'richTextEnabled' | 'richTextOptions' | 'extraActions' | 'plugins'>;
