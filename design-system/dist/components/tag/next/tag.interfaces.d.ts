...
import { SvgComponentType } from '../../../types/svg-component.interface';
 ...
 */
export type TagKind = 'positive' | 'negative' | 'warning' | 'neutral' | 'peace' | 'power' | 'brand' | 'ai';
/**
 * Tag sizes (height):
 * - sm: 20px (small)
 * - md: 24px (medium)
 ...
 */
export type TagProps = PropsWithChildren<WithTestId<{
    $style?: StyleObject;
    kind: TagKind;
    variant: TagVariant;
    shape?: TagShape;
