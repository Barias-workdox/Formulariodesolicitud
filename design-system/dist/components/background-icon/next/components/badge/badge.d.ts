import { BackgroundIconKind, BackgroundIconShape, BackgroundIconSize } from '../../background-icon.interfaces';
/**
 ...
 */
export declare const Badge: ({ kind, size, shape, "data-testid": dataTestId, }: BadgeProps) => JSX.Element;
