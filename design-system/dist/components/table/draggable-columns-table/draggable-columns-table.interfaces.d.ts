...
export interface DraggableColumnsTableProps extends Partial<Pick<ColumnMenuPopoverProps, 'updateSortingColumn'>> {
    /**
...
export interface ColumnHeaderProps extends Pick<ColumnMenuPopoverProps, 'dataTestId' | 'toggleActiveColumn' | 'updateSortingColumn'> {
    column: ColumnProps;
    paddingLeft: number;
    paddingRight: number;
    setDraggingColumnId(columnId: string): void;
...
export interface ColumnMenuOptionsProps extends Pick<ColumnMenuPopoverProps, 'column' | 'toggleActiveColumn' | 'updateSortingColumn'> {
    close(): void;
}
