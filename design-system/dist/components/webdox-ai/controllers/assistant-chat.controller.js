...
import "zod";
import { conversationConstants as l } from "../constants/conversation.constant.js";
import { messageConstants as f } from "../constants/message.constant.js";
...
import { WebdoxAIChatController as h } from "./webdox-ai-chat.controller.js";
const Ci = (p) => {
  const {
    "data-testid": g = "assistant-chat",
    conversationDisabled: d,
    conversationDispatch: t = i,
    selectedTab: s,
    onSuggestionsClick: e = i,
    onTempAnswerSubmit: n = i,
    onCreateMessage: a = i,
    suggestions: o = []
  } = p, u = m(() => {
    t({
      type: l.actions.suggestionsAnswer,
      payload: {
        question: {
          value: "",
          variant: "temp"
    ...
    (r, c = {}) => {
      const { item: w = {} } = c;
      f.specialAnswerId.suggestions === w.id && t({
        type: l.actions.suggestionsAnswer,
        payload: {
          question: {
            value: "",
  ...
  return /* @__PURE__ */ A(
    h,
    {
      ...
      "data-testid": g,
      disabled: d,
      onSuggestionsClick: u,
      onTempAnswerSubmit: C,
      onCreateMessage: b
    }
  );
};
export {
  Ci as AssistantChatController
};
//# sourceMappingURL=assistant-chat.controller.js.map
