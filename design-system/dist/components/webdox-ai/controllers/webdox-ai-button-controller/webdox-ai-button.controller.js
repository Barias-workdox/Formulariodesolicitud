...
import { getOverrideProps as a } from "../../../../utils/overrides.utils.js";
import { WebdoxAIButton as W } from "../../components/webdox-ai-button/webdox-ai-button.js";
import { WebdoxAIButtonInformationPopover as g } from "../../components/webdox-ai-button-information-popover/webdox-ai-button-information-popover.js";
...
const w = {
  ...
  const {
    ...
    sendTextValue: x,
    isDisabled: P
  } = u ?? {}, { Button: B, Popover: A } = l || {}, V = c(() => {
    !o && !t && r();
  }, [t, o, r]), I = t ? w[s] ?? "genericError" : void 0, i = (o ? "loading" : I) || "active", _ = i === "active" ? v : !0, C = c(() => {
    i === "active" ? r() : e();
  }, [r, e, i]), D = {
    "data-testid": `${m}__webdox-ai-button`,
    isLoading: o,
    hasError: t,
    onClick: V,
    ...a(B)
  ...
  return /* @__PURE__ */ n(
    g,
    {
      ...
      isDisabled: P,
      ...a(A),
      children: /* @__PURE__ */ n(W, { ...D })
    }
  );
};
export {
  Ft as WebdoxAIButtonController
};
//# sourceMappingURL=webdox-ai-button.controller.js.map
