...
import { LegalWhisperAnswerType, LegalWhisperConversation, LegalWhisperQuestion } from './legal-whisper.interfaces';
...
export type ConversationAction = SetConversationAction | CreateQuestionAction | PersistAnswerAction | UpdateDisabledAction;
