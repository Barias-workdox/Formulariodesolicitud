...
import { AssistantAIServiceType, ChatAssistantContractSummaryType } from '.';
import { ChatBotAnswerTypeV2 } from './chat-bot.interfaces';
...
export type PromptKind = 'contract_summary' | 'first_party' | 'second_party' | 'contract_dates' | 'contract_amount' | 'contract_summary_json'
...
export type WebdoxAIErrorType = 'documentEnable' | 'createQuestion' | 'createConversation' | 'fetchConversation' | 'encryptedDocument';
