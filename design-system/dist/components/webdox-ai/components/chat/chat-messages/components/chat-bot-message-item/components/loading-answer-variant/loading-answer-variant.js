...
import { WebdoxAISpinner as n } from "../../../../../../webdox-ai-spinner/webdox-ai-spinner.js";
...
import { ChatMessageLayout as e } from "../../../chat-message-layout/chat-message-layout.js";
...
const tt = ({ dataTestId: o }) => {
  const { t } = p();
  return /* @__PURE__ */ r(e, { kind: "primary", children: /* @__PURE__ */ i(a, { children: [
    /* @__PURE__ */ r(n, { dataTestId: `${o}--spinner` }),
    /* @__PURE__ */ r(
      m,
      {
        variant: "microCopy",
        color: "neutral",
        margin: 0,
        children: t("webdoxAI.chat.processingAnswer")
      }
    )
  ] }) });
};
export {
  tt as LoadingAnswerVariant
};
//# sourceMappingURL=loading-answer-variant.js.map
