...
import { MessageList as g } from "../../../../../../message-list/message-list.js";
import "react";
import "baseui/list";
import "baseui";
import "../../../../../../../../truncated-text/truncated-text.js";
import { StyledBaseParagraphText as c } from "../../../../../../styled-base-paragraph-text/styled-base-paragraph-text.js";
import { ChatMessageLayout as l } from "../../../chat-message-layout/chat-message-layout.js";
import "dompurify";
import "../../../../../../../../text/text.js";
...
const dr = ({
  ...
  const { t: p } = d(), s = (e) => {
    i("promptsSuggestions", {
      id: r,
      item: e
    });
  };
  return /* @__PURE__ */ t(l, { kind: "primary", children: /* @__PURE__ */ n(u, { children: [
    /* @__PURE__ */ t(c, { children: p("webdoxAI.chat.suggestionsAnswer.description") }),
    /* @__PURE__ */ t(
      g,
      {
...
export {
  dr as PromptsSuggestionAnswerVariant
};
//# sourceMappingURL=prompts-suggestion-answer-variant.js.map
