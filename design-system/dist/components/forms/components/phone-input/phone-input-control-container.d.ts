import { PhoneInputControlProps } from './phone-input-control';
 ...
 */
export declare const PhoneInputControlContainer: (props: PhoneInputControlContainerProps) => JSX.Element;
