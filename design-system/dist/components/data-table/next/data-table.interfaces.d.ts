...
export type ActiveColumn<ColumnId = string> = Pick<ColumnConfig<ColumnId>, 'id'> & CustomizableColumnConfigProps;
...
export type TableActionsColumnHeaderCellProps = WithTestId & Pick<DataTableContextValues, 'columnsConfig' | 'allColumnsConfig' | 'handleOnChange'> & {
    showButton?: boolean;
    overrides?: {
...
type OnTableChangeValues<DataType extends Record<string, unknown> = Record<string, unknown>, ExtraColumnsIds extends string = never> = DataTableProps<DataType, ExtraColumnsIds> & Pick<DataTableContextValues<DataType, ExtraColumnsIds>, 'columnsConfig'>;
/**
