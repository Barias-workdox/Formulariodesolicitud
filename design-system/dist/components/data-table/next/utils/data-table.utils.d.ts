...
import { ActiveColumn, AllKeys, ColumnConfig, ColumnType, CustomColumnConfigLabel, PaginationSettings, TableCellRenderType } from '../data-table.interfaces';
 ...
 */
export declare const getActiveColumnsConfigWithUserCustomizations: <DataType extends Record<string, unknown> = Record<string, unknown>, ExtraColumnsIds extends string = never>(activeColumns?: ActiveColumn<keyof DataType | ExtraColumnsIds>[], allColumns?: ColumnConfig<AllKeys<DataType> | ExtraColumnsIds>[]) => ColumnConfig<AllKeys<DataType> | ExtraColumnsIds>[];
/**
 ...
 */
export declare const getActiveColumnFromConfig: <ColumnId extends string>({ id, width, }: ColumnConfig<ColumnId>) => ActiveColumn<ColumnId>;
/**
 ...
 * ```
 */
export declare const getTableData: <DataType extends Record<string, unknown> = Record<string, unknown>, ExtraColumnsIds extends string = never>({ defaultValue, rawData, activeColumns, allColumnsConfig, actionCell, customRenders, }: GetTableDataParams<DataType, ExtraColumnsIds>) => ReactNode[][];
/**
 ...
 */
export declare const getInfiniteLoadingCells: <DataType extends Record<string, unknown> = Record<string, unknown>, ExtraColumnsIds extends string = never>({ isLoading, activeColumns, allColumnsConfig, actionCell, paginationSettings: { itemsPerPage }, }: GetTableDataParams<DataType, ExtraColumnsIds>) => ReactNode[][];
/**
 ...
 */
export declare const getColumnLabel: (label: ColumnConfig["label"], type: keyof CustomColumnConfigLabel) => ReactNode;
/**
