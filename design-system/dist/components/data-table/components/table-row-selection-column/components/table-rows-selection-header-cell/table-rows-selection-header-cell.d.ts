 ...
 */
export declare const TableRowsSelectionHeaderCell: ({ "data-testid": dataTestId, isAllCheck, isIndeterminate, onClickAll, overrides, }: TableRowsSelectionHeaderCellProps) => ReactElement;
