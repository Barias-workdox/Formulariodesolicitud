...
export declare const cellStyles: {
    containerStyles: (theme: DesignSystemTheme, { isHeaderHovered, isRowHovered, isRowChecked, isRowClickable, isDragging, isRowDisabled, align, height, isActionCell, }?: StyleOptions) => StyleObject;
};
export {};
