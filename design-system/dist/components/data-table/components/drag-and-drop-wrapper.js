...
const A = ({ children: a }) => {
  const { data: n, columnsConfig: i, listRef: e, totalHeight: l, containerRef: p, handleOnChange: s } = I(), { dragSourceIndex: c, dragDestinationIndex: m, onDragStart: d, onDragUpdate: f, onDragEnd: g } = R({
    data: n,
    columnsConfig: i,
    updateTable: s
  }), D = u(
