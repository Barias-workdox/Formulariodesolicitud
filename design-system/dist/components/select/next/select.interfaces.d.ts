...
import { EnhancerType, InputKind, Size } from '../../input/next/input.interfaces';
import { WithZIndex } from '../../../interfaces/common.interfaces';
import { Option as BaseOption, SelectProps as BaseSelectProps, Options, Value } from 'baseui/select';
...
export type SelectProps = WithZIndex & WithIsHoveredProps & Omit<BaseSelectProps, 'value' | 'size' | 'onChange' | 'onCreate' | 'options'> & {
    'data-testid'?: string;
