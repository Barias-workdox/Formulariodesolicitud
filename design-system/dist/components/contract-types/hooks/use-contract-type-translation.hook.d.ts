import { CONTRACT_TYPE_NAMESPACE } from '../../utils';
import { es as baseLang } from '../../../locales/contract-types/es';
...
type UseContractTypeTranslationResponse = _UseTranslationResponse<typeof CONTRACT_TYPE_NAMESPACE, undefined> & {
...
export declare const useContractTypeTranslation: () => UseContractTypeTranslationResponse;
export {};
