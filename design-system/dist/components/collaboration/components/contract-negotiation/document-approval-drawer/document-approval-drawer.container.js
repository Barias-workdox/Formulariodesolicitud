...
import { DocumentApprovalDrawer as u } from "./document-approval-drawer.js";
import { validationSchema as l, FORM_DEFAULT_VALUES as D } from "./document-approval-form.logic.js";
const bo = ({
  "data-testid": i,
  document: p,
  documentLastModificationText: e,
  isLoading: a = !1,
  isOpen: o,
  onClose: s,
  onSubmit: f
  ...
  return d(() => {
    t();
  }, [o, t]), /* @__PURE__ */ m(n, { ...r, children: /* @__PURE__ */ m(
    u,
    {
      "data-testid": i,
      isOpen: o,
...
export {
  bo as DocumentApprovalDrawerContainer
};
//# sourceMappingURL=document-approval-drawer.container.js.map
