...
const Fo = {
  ...
  comment: o.string(),
  document: o.mixed().required()
}), fo = () => t();
export {
  Fo as FORM_DEFAULT_VALUES,
  fo as useNewDocumentVersionFormContext,
  lo as validationSchema
};
//# sourceMappingURL=new-document-version-drawer.logic.js.map
