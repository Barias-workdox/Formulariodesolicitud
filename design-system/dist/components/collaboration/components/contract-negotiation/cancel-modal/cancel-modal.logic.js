...
const xo = () => {
  ...
  return o.object().shape({
    message: o.string().trim().required(r("forms.validations.required"))
  });
}, Fo = () => t();
export {
  Fo as useCancelCollaborationFormContext,
  xo as useCancelCollaborationFormValidationSchema
};
//# sourceMappingURL=cancel-modal.logic.js.map
