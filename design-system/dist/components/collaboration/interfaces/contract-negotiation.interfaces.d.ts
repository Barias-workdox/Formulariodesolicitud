...
import { CollaborationActivity, CollaborationDetails, CollaborationDocument, CollaborationResource, CollaborationResourceStatus, CollaborationSubtask, CollaborationUser, ContractNegotiationTab, DocumentVersion, ThirdParty } from './collaboration.interfaces';
import { CancelCollaborationFormFields, FinalizeNegotiationFormFields } from './contract-negotiation-forms.interfaces';
...
import { ActivityTimelineProps } from '../../activity-timeline';
import { MessageType, MessagesProps, MessagesUser } from '../../messages';
/** Type of the possible statues used on information of a document */
export type CollaborationResourceStatusInfo = Extract<CollaborationResourceStatus, 'approved' | 'pending'>;
/**
 ...
 */
export type OnApproveDocumentType = (document: CollaborationResource, payload: {
    comment: string;
}, callback: () => void) => void;
/**
 ...
 */
export type OnNewDocumentVersionType = (document: CollaborationResource, payload: Pick<NewDocumentVersionFormFields, 'comment' | 'document'>, callback: () => void) => void;
/**
...
export type CollaborationActivityDocument = Pick<CollaborationDocument, 'id' | 'name' | 'fileExt' | 'updatedAt' | 'officeDocumentVersion'> & {
...
export type IContractNegotiationContext = Pick<IContractNegotiation, 'allowedFileExtensions' | 'collaborationDetails' | 'collaborationResponsible' | 'currentThirdParty' | 'isDocumentPreviewLoading' | 'isLoading' | 'isSendMessageLoading' | 'messages' | 'selectedDocumentPreviewUrl' | 'selectedDocumentAttachmentUrl' | 'selectedDocumentVersions' | 'stakeholders' | 'loadMoreMessages' | 'onApproveDocument' | 'onDownloadDocument' | 'onNewDocumentVersion' | 'onSendMessage' | 'onTriggerActivityTab' | 'onTriggerHistoryTab' | 'loadMoreActivities' | 'collaborationActivities' | 'isActivitiesLoading' | 'onWriteNewDocumentVersion'> & {
