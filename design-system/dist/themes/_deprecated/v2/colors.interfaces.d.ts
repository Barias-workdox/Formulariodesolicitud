...
type Role = BaseRole | 'neutral' | 'brand' | 'bgBrandAI' | 'positive' | 'negative' | 'warning' | 'peace' | 'power' | 'nature' | 'sweet' | 'heat';
type Modifier = '' | 'washed' | 'subtle' | 'depressed' | 'subdued' | 'medium' | 'strong';
/**
 ...
 * ```
 */
export type ColorTokenName<E extends Element = Element> = `${E}${Capitalize<Role>}${Capitalize<Modifier>}`;
