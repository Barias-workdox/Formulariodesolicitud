 ...
 */
type Role = 'brand' | 'neutral' | 'positive' | 'negative' | 'warning' | 'peace' | 'power' | 'nature' | 'sweet' | 'heat';
type BaseRole = 'base';
/**
 ...
 */
type Modifier = '' | 'base' | 'washed' | 'subtle' | 'depressed' | 'subdued' | 'medium' | 'strong';
/**
 ...
 */
type Deprecated_ColorTokenName<E extends Element = Element> = `${E}${Capitalize<BaseRole | Role>}${Capitalize<Modifier>}`;
/**
 ...
 */
export type SemanticColors = Partial<Record<ColorTokenName | Deprecated_BgColorToken | Deprecated_TextColorToken | Deprecated_IconColorToken | Deprecated_BorderColorToken, string>>;
export {};
