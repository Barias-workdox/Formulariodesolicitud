...
import { Typography } from './_deprecated/v1/typographies';
import { SemanticColors } from './v3/interfaces/colors.interfaces';
import { UIColorTokens } from './v3/interfaces/ui-colors.interfaces';
import { RemoveIndexSignature } from '../types/utils/remove-index-signature';
import { Borders } from './v3/tokens/borders';
import { Breakpoints } from './v3/tokens/breakpoints';
import { Elevations } from './v3/tokens/elevations';
import { Spacing } from './v3/tokens/spacing';
import { ColorTokens as BaseColors, Typography as BaseTypography } from 'baseui/styles';
import { Lighting as DefaultLighting, MediaQuery as DefaultMediaQuery, Theme as DefaultTheme, Typography as DefaultTypography } from 'baseui/theme';
 ...
 */
export type AppColors = StrictBaseColors & Required<SemanticColors> & UIColorTokens & ExtendedColors;
...
export interface DesignSystemTheme extends Omit<DefaultTheme, 'colors' | 'typography' | 'breakpoints' | 'mediaQuery' | 'lighting' | 'borders'> {
    colors: AppColors;
