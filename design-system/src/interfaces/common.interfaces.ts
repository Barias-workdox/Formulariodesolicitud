...
import type { PLACEMENT } from '@constants/placement.constants';
...
export type WithTestId<T extends object = undefined> = T extends undefined
  ? WithTestIdProps
  : WithTestIdProps & T;

/** Extends T only if it is not an empty object */
export type WithZIndex<T extends object = undefined> = T extends undefined
  ? WithZIndexProps
  : WithZIndexProps & T;
