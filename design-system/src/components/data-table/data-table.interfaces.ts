...
import type { UseTableAction, UseTableReturn } from './hooks/use-table';
...
> = Partial<DataTableProps<DataType, ExtraColumnsIds>> & {
...
export type TableActionsColumnHeaderCellProps<
  DataType extends Record<string, unknown> = Record<string, unknown>,
  ExtraColumnsIds = never,
> = WithTestId &
