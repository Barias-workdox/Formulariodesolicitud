...
import { MenuItemLabel } from '@components/data-table/components/common/menu-item-label';
import { PopoverMenu } from '@components/data-table/components/popover-menu';
import { TABLE_MENU_SEARCH_FILTER_THRESHOLD } from '@components/data-table/data-table.constants';
  ...
  const filteredItems = useMemo(
    () =>
      missingColumns.filter(({ label }) =>
        includesStringNormalized(getStringFromReactNode(label), searchValue),
      ),
