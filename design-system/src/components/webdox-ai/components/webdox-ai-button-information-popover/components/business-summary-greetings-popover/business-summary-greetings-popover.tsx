...
import { PopoverTitleWithIcon } from '../../next/components';
import {
  StyledEmoji,
...
/**
 * Component for rendering an information popover for business summary greetings.
 */
export const BusinessSummaryGreetingsPopover = ({
