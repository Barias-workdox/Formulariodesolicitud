...
import type {
  ActionCableCable,
  ActionCableContextValues,
} from '../../../contexts/action-cable-context';
...
export type WebdoxAIBroadcastSubscribeType = ReturnType<
  WebdoxAIBroadcastContextValues['subscribe']
>;
