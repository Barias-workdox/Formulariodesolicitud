...
import { LegalWhisperGreetingsInformationPopover } from '../../components/webdox-ai-button-information-popover/components/legal-whisper-greetings-information-popover';
...
const renderComponent = (props?: Partial<InformationPopoverCommonProps>): RenderType =>
  render(
    <LegalWhisperGreetingsInformationPopover
      {...defaultProps}
      {...props}
    >
...
describe('LegalWhisperGreetingsInformationPopover - tests', () => {
