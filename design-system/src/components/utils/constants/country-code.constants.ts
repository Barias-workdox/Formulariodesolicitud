import type { CountryCodeType } from '../interfaces';

/**
 * UN member states (ISO 3166-1 alpha-3, 193 countries)
 * https://www.un.org/en/about-us/member-states
 */
export const sovereignCountryCodes: CountryCodeType[] = [
  'AFG', // Afghanistan
  'ALB', // Albania
  'DZA', // Algeria
  'AND', // Andorra
 ...
 */
export const nonUnSovereignCountryCodes: CountryCodeType[] = [
 ...
 */
export const territoryCodes: CountryCodeType[] = [
  'ALA', // Åland Islands
  'ABW', // Aruba
  'AIA', // Anguilla
  'ASM', // American Samoa
 ...
 */
export const specialAreaCodes: CountryCodeType[] = [
  'ATA', // Antarctica
 ...
 */
export const otherCodes: CountryCodeType[] = [
  'XKX', // Kosovo
 ...
 */
export const allCountryCodes: CountryCodeType[] = [
