import type { CountryCodeType } from './country-code.interface';
import type {
  nicDefaultTextsMap,
  nicDefaultValidationTextsMap,
} from '../../forms/validations/nic/default/default.i18n';
...
export type NicValidationsTextsByNationalIdentificationKindCode =
  typeof nicDefaultValidationTextsMap;
