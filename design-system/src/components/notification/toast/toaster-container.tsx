import { ToasterContainer as BaseToasterContainer } from 'baseui/toast';

import { PLACEMENT } from '../../popover';
import { CloseIconToast, StyledToastBody } from '../components';

import { DEFAULT_TOAST_DURATION_MS } from './toast.constants';
import { toastOverrides } from './toaster-container.styles';

import type { ToasterProps } from 'baseui/toast';
...
}: ToasterContainerProps): JSX.Element => {
  return (
    <BaseToasterContainer
      placement={placement}
      autoHideDuration={duration}
      overrides={{
        ...toastOverrides({ zIndex, marginX, marginY }),
        ToastCloseIcon: {
          props: {
            'data-testid': 'toaster__close-button',
          },
          component: CloseIconToast,
        },
        ToastBody: {
          component: StyledToastBody,
          props: { width },
        },
      }}
    >
