...
import {
  ...
  type PhoneInputControlContainerProps,
} from '../phone-input-control-container';

import type { RenderType } from '@test/test-utils';

const countryCodeAriaLabel = 'Select country aria label';
const defaultProps: PhoneInputControlContainerProps = {
...
const renderComponent = (props?: Partial<PhoneInputControlContainerProps>): RenderType => {
  return render(
...
describe('phone-input-control-container - tests', () => {
