import type {
  FieldValues,
  UseFormProps as UseNativeFormProps,
  UseFormReturn as UseNativeFormReturn,
 ...
 */
export type SchemaType<R extends ResolverType> = R extends 'yup'
  ? yup.AnyObjectSchema
  : R extends 'zod'
    ? zod.ZodType
    : never;
...
>
  extends UseNativeFormProps<TFieldValues, TContext>, AdditionalProps<R> {}
...
> = UseNativeFormReturn<TFieldValues, TContext, TTransformedValues>;
