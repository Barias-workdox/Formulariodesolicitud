import type { FileType } from '../file-type-icon/file-type-icon.interfaces';
...
export type FileUploadItem = FileUploadItemBase<
  FileUploadItemDefault | FileUploadItemRejected | FileUploadItemUploading
>;
