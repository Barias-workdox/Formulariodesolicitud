import type { AriaAttributes, FunctionComponent } from 'react';
...
export type ButtonEnhancer = FunctionComponent<{ size?: string | number }>;

export interface ButtonProps
  extends
    Omit<
      BaseButtonProps,
      'kind' | 'size' | 'startEnhancer' | 'endEnhancer' | 'shape' | 'colors' | 'onClick'
    >,
    WithTestId,
    AriaAttributes {
  /** Shows loading state */
